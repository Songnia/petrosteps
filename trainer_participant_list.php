 ...
 ***********************************************************************************/
 ...
 $db = new DB();
  $session_id = $db->get_active_session((int) $_SESSION['user_id']);
  if($session_id === false || $_SESSION['session_id'] !== $session_id){
    session_unset();
    header('Location:login.php');
    exit;
  }
...
<div class="md3-page-header">
  <div>
    ...
    <p class="md3-page-subtitle">Manage your assigned participants</p>
  </div>
</div>
...
<div class="md3-table-container">
  <div class="md3-table-toolbar">
    ...
    <div class="md3-table-actions">
      <a href="participant_add.php"><button class="md3-btn md3-btn--filled"><span class="material-symbols-outlined">person_add</span> Add Participant</button></a>
    </div>
  </div>
...
function loadData(page)
{
  ...
  ({
    type: "POST",
    url: "ajax_trainer_participants.php",
    data: "trainer_id="+<?php echo $_SESSION['user_id']; ?>+"&user_type=Participant&page="+page+"&str="+searchStr+"&sort="+sort+"&order="+order,
