...
<head>
  ...
  <title>Trainer Users — <?php echo APP_NAME; ?></title>
...
<div class="md3-page-header">
  <div>
    <h1 class="md3-page-title">Trainer Users</h1>
    <p class="md3-page-subtitle">Manage trainer user accounts</p>
  </div>
</div>

<div class="md3-table-container">
  <div class="md3-table-toolbar">
    <h2 class="md3-table-title">Trainer User List</h2>
    <div class="md3-table-actions">
      <a href="trainer_add.php"><button class="md3-btn md3-btn--filled"><span class="material-symbols-outlined">add</span> Add Trainer</button></a>
    </div>
  </div>

  <form action="trainer_edit.php" method="post" name="edit_form">
  ...
  <div style="padding: 12px 24px;">
    <div class="md3-search-field">
      ...
      <input type="text" id="appendedInput" onkeyup="loadData(1);" placeholder="Search trainers...">
    </div>
  </div>
...
function loadData(page)
{
	...
	({
		...
		url: "ajax_admin_users.php",
	 	data: "user_type=Trainer&page="+page+"&str="+searchStr+"&sort="+sort+"&order="+order,
