...
<head>
  ...
  <title>Admin Users — <?php echo APP_NAME; ?></title>
...
<div class="md3-page-header">
  <div>
    <h1 class="md3-page-title">Admin Users</h1>
    <p class="md3-page-subtitle">Manage administrator accounts</p>
  </div>
</div>

<div class="md3-table-container">
  <div class="md3-table-toolbar">
    <h2 class="md3-table-title">Admin User List</h2>
    <div class="md3-table-actions">
      <a href="admin_user_add.php"><button class="md3-btn md3-btn--filled"><span class="material-symbols-outlined">add</span> Add Admin</button></a>
    </div>
  </div>

  <form action="admin_user_edit.php" method="post" name="edit_form">
  ...
  <div style="padding: 12px 24px;">
    <div class="md3-search-field">
      ...
      <input type="text" id="appendedInput" onkeyup="loadData(1);" placeholder="Search admins...">
    </div>
  </div>
...
function loadData(page)
{
	...
	({
	 ...
	 data: "user_type=Admin&page="+page+"&str="+searchStr+"&sort="+sort+"&order="+order,
