...
<head>
  ...
  <title>Block List — <?php echo APP_NAME; ?></title>
...
<div class="md3-page-header">
  <div>
    <h1 class="md3-page-title">Block List</h1>
    <p class="md3-page-subtitle">Manage block master data</p>
  </div>
</div>

<div class="md3-table-container">
  <div class="md3-table-toolbar">
    <h2 class="md3-table-title">Block List</h2>
    <div class="md3-table-actions">
      <a href="block_add.php"><button class="md3-btn md3-btn--filled"><span class="material-symbols-outlined">add</span> Add Block</button></a>
    </div>
  </div>

  <form action="block_edit.php" method="post" name="edit_form">
  ...
  <div style="padding: 12px 24px;">
    <div class="md3-search-field">
      ...
      <input type="text" id="appendedInput" onkeyup="loadData(1);" placeholder="Search blocks...">
    </div>
  </div>

  <input type="hidden" id="order" value="asc">
  <input type="hidden" id="sort" value="Block_Name">
...
function delete1(id) {
  document.getElementById('bid').value = id;
  document.getElementById('form_action').value = "delete_block";
  if(!document.getElementById('bid').value)
    {
      alert("Error occured please try again");
      return false;
