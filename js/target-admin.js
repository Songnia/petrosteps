var target_admin = function () {
  ...
  function bindEvents(){
    $('.see_graph_btn').unbind().bind('click', function(){
      $.ajax
      ({
        type: "POST",
        url: "ajax_calculation.php",
        data: "action=chartshowhide&type=show",
    ...
    $('.hide_graph_btn').unbind().bind('click', function(){
      $.ajax
      ({
        type: "POST",
        url: "ajax_calculation.php",
        data: "action=chartshowhide&type=hide",
        success: function(msg) {
          $('#mainChartDiv').hide();
          $('.see_graph_btn').show();
          $('.hide_graph_btn').hide();
